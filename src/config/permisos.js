...
export const MODULOS = [
  ...
  },
  {
    ...
    permisos: [
      ...
      { key: 'ver_capacitaciones_hv',   accion: 'ver',      label: 'Ver pestaña Capacitaciones',             labelCorto: 'Ver capac.',    desc: 'Permite ver la pestaña Capacitaciones dentro de la Hoja de Vida.', default: true },
      { key: 'ver_evaluaciones_hv',     accion: 'ver',      label: 'Ver pestaña Evaluaciones',               labelCorto: 'Ver eval.',     desc: 'Permite ver la pestaña Evaluaciones dentro de la Hoja de Vida.', default: true },
      { key: 'ver_ausencias_hv',        accion: 'ver',      label: 'Ver pestaña Permisos y Licencias',       labelCorto: 'Ver lic.',      desc: 'Permite ver la pestaña Permisos y Licencias (ausencias/cometidos/vacaciones) dentro de la Hoja de Vida.', default: true },
      { key: 'crear_anotaciones_hv',    accion: 'crear',    label: 'Crear anotaciones en Hoja de Vida',      labelCorto: 'Crear anot.',   desc: 'Permite registrar anotaciones (atrasos, amonestaciones, felicitaciones, etc.) en la Hoja de Vida.' },
      { key: 'editar_anotaciones_hv',   accion: 'editar',   label: 'Editar anotaciones en Hoja de Vida',     labelCorto: 'Editar anot.',  desc: 'Permite modificar anotaciones registradas en la Hoja de Vida.' },
      { key: 'eliminar_anotaciones_hv', accion: 'eliminar', label: 'Eliminar anotaciones en Hoja de Vida',   labelCorto: 'Elim. anot.',   desc: 'Permite eliminar anotaciones de la Hoja de Vida de forma permanente.' },
    ],
  },
  {
