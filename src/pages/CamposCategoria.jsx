...
const CAMPOS_SISTEMA = [
  ...
  'licencia_windows','win_tipo_licencia','win_version','win_proveedor','win_factura','win_fecha_factura','win_orden',
  'licencia_office','off_tipo_licencia','off_version','off_proveedor','off_factura','off_fecha_factura','off_orden',
]
...
const CAMPOS_PREDET = {
  computadores: [
    ...
    { id: 'win_tipo_licencia',   nombre: 'Tipo licencia Windows',     tipo: 'select' },
    { id: 'licencia_windows',    nombre: 'Clave Windows',             tipo: 'texto'  },
    { id: 'win_version',         nombre: 'Versión Windows',           tipo: 'texto'  },
    { id: 'win_proveedor',       nombre: 'Proveedor Windows',         tipo: 'texto'  },
    { id: 'win_factura',         nombre: 'N° Factura Windows',        tipo: 'texto'  },
    { id: 'win_fecha_factura',   nombre: 'Fecha factura Windows',     tipo: 'fecha'  },
    { id: 'win_orden',           nombre: 'N° Orden Windows',          tipo: 'texto'  },
    { id: 'off_tipo_licencia',   nombre: 'Tipo licencia Office',      tipo: 'select' },
    { id: 'licencia_office',     nombre: 'Clave Office',              tipo: 'texto'  },
    { id: 'off_version',         nombre: 'Versión Office',            tipo: 'texto'  },
    { id: 'off_proveedor',       nombre: 'Proveedor Office',          tipo: 'texto'  },
    { id: 'off_factura',         nombre: 'N° Factura Office',         tipo: 'texto'  },
    { id: 'off_fecha_factura',   nombre: 'Fecha factura Office',      tipo: 'fecha'  },
    { id: 'off_orden',           nombre: 'N° Orden Office',           tipo: 'texto'  },
    ...
    { id: 'numero_orden',        nombre: 'N° orden de compra',        tipo: 'texto'  },
...
const FORM_SECTIONS = {
  comp: [
    ...
    { label: '🪟 Windows',          ids: ['win_tipo_licencia','licencia_windows','win_version','win_proveedor','win_factura','win_fecha_factura','win_orden'] },
    { label: '🏢 Office',           ids: ['off_tipo_licencia','licencia_office','off_version','off_proveedor','off_factura','off_fecha_factura','off_orden'] },
