...
const CAMPOS = {
  comp: {
    ...
    opcionales: [
      ...
      { col: 'licencia_windows',    desc: 'Clave de licencia Windows' },
      { col: 'win_version',         desc: 'Versión Windows (ej: Windows 11 Pro)' },
      { col: 'win_tipo_licencia',   desc: 'fabricante / key / oem / volumen' },
      { col: 'win_proveedor',       desc: 'Proveedor licencia Windows' },
      { col: 'win_factura',         desc: 'N° Factura licencia Windows' },
      { col: 'win_fecha_factura',   desc: 'Fecha factura licencia Windows' },
      { col: 'win_orden',           desc: 'N° Orden compra licencia Windows' },
      { col: 'licencia_office',     desc: 'Clave de licencia Office' },
      { col: 'off_version',         desc: 'Versión Office (ej: Microsoft 365)' },
      { col: 'off_tipo_licencia',   desc: 'key / alternativa / volumen' },
      { col: 'off_proveedor',       desc: 'Proveedor licencia Office' },
      { col: 'off_factura',         desc: 'N° Factura licencia Office' },
      { col: 'off_fecha_factura',   desc: 'Fecha factura licencia Office' },
      { col: 'off_orden',           desc: 'N° Orden compra licencia Office' },
      { col: 'fecha_adquisicion',   desc: 'Fecha adquisición' },
      { col: 'proveedor',           desc: 'Proveedor del equipo' },
  ...
  tecno: {
    obligatorios: [
      { col: 'codigo',           desc: 'Código inventario' },
      { col: 'tipo',             desc: 'Proyector / Impresora / Smart TV / etc.' },
      { col: 'marca',            desc: 'Marca' },
      { col: 'estado',           desc: 'Bueno / Regular / Malo / Baja' },
    ],
    opcionales: [
      { col: 'tecnologia',       desc: 'Tecnología (ej: LED, Láser, Inkjet)' },
      { col: 'modelo',           desc: 'Modelo' },
      { col: 'numero_serie',     desc: 'Número de serie' },
      { col: 'consumible',       desc: 'Consumible (ej: Tóner HP 26A)' },
...
const EJEMPLOS_BASE = {
  ...
  tecno: {
    codigo: 'TEC-001', tipo: 'Proyector', tecnologia: 'LED', marca: 'Epson', modelo: 'PowerLite X49', estado: 'Bueno',
    numero_serie: 'SER-987654', consumible: 'Lámpara ELPLP96', cantidad: '1', ubicacion: 'Sala Reuniones',
