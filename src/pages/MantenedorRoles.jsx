...
const ACCIONES = [
  ...
  { key: 'ver_papelera',             label: 'Ver Papelera',             desc: 'Permite acceder a la Papelera y ver los registros eliminados.' },
  { key: 'restaurar_registros',      label: 'Restaurar registros',      desc: 'Permite restaurar registros desde la Papelera.' },
  { key: 'eliminar_permanentemente', label: 'Eliminar permanentemente', desc: 'Permite eliminar registros de forma permanente desde la Papelera.' },
  { key: 'ver_auditoria_papelera',   label: 'Ver auditoría de papelera',desc: 'Permite ver el historial de acciones realizadas en la Papelera.' },
