...
export default function ModalCamposCategoria({ catObj, usuario, onClose, onCatUpdated }) {
  ...
  return (
    <div
      style={{ position: 'fixed', inset: 0, background: 'rgba(5,12,55,0.60)', backdropFilter: 'blur(5px)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 950, padding: '16px' }}
      onClick={onClose}
    >
      <div
